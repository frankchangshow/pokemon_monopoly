...
export const BoardSpaces = [
  ...
  { id: 1, name: "Mediterranean Avenue", type: "property", pokemon: "Lechonk", cost: 60, rent: [2, 10, 30, 90, 160, 250], houseCost: 50, group: "brown" },
  { id: 2, name: "Community Chest", type: "raid", cost: 0, rent: 0, group: "card" },
  { id: 3, name: "Baltic Avenue", type: "property", pokemon: "Tarountula", cost: 60, rent: [4, 20, 60, 180, 320, 450], houseCost: 50, group: "brown" },
  { id: 4, name: "Income Tax", type: "tax", cost: 200, rent: 0, group: "tax" },
  { id: 5, name: "Reading Railroad", type: "station", pokemon: "Rookidee", cost: 200, rent: [25, 50, 100, 200], group: "station" },
  { id: 6, name: "Oriental Avenue", type: "property", pokemon: "Pawmi", cost: 100, rent: [6, 30, 90, 270, 400, 550], houseCost: 50, group: "light-blue" },
  { id: 7, name: "Chance", type: "academy", cost: 0, rent: 0, group: "card" },
  { id: 8, name: "Vermont Avenue", type: "property", pokemon: "Fidough", cost: 100, rent: [6, 30, 90, 270, 400, 550], houseCost: 50, group: "light-blue" },
  { id: 9, name: "Connecticut Avenue", type: "property", pokemon: "Smoliv", cost: 120, rent: [8, 40, 100, 300, 450, 600], houseCost: 50, group: "light-blue" },
  { id: 10, name: "Jail / Just Visiting", type: "jail", cost: 0, rent: 0, group: "corner" },
  { id: 11, name: "St. Charles Place", type: "property", pokemon: "Tandemaus", cost: 140, rent: [10, 50, 150, 450, 625, 750], houseCost: 100, group: "pink" },
  { id: 12, name: "Electric Company", type: "utility", pokemon: "Rotom", cost: 150, rent: [4, 10], group: "utility" },
  { id: 13, name: "States Avenue", type: "property", pokemon: "Nacli", cost: 140, rent: [10, 50, 150, 450, 625, 750], houseCost: 100, group: "pink" },
  { id: 14, name: "Virginia Avenue", type: "property", pokemon: "Charcadet", cost: 160, rent: [12, 60, 180, 500, 700, 900], houseCost: 100, group: "pink" },
  { id: 15, name: "Pennsylvania Railroad", type: "station", pokemon: "Rookidee", cost: 200, rent: [25, 50, 100, 200], group: "station" },
  { id: 16, name: "St. James Place", type: "property", pokemon: "Orthworm", cost: 180, rent: [14, 70, 200, 550, 750, 950], houseCost: 100, group: "orange" },
  { id: 17, name: "Community Chest", type: "raid", cost: 0, rent: 0, group: "card" },
  { id: 18, name: "Tennessee Avenue", type: "property", pokemon: "Toedscool", cost: 180, rent: [14, 70, 200, 550, 750, 950], houseCost: 100, group: "orange" },
  { id: 19, name: "New York Avenue", type: "property", pokemon: "Capsakid", cost: 200, rent: [16, 80, 220, 600, 800, 1000], houseCost: 100, group: "orange" },
  { id: 20, name: "Free Parking", type: "parking", cost: 0, rent: 0, group: "corner" },
  { id: 21, name: "Kentucky Avenue", type: "property", pokemon: "Grafaiai", cost: 220, rent: [18, 90, 250, 700, 875, 1050], houseCost: 150, group: "red" },
  { id: 22, name: "Chance", type: "academy", cost: 0, rent: 0, group: "card" },
  { id: 23, name: "Indiana Avenue", type: "property", pokemon: "Shroodle", cost: 220, rent: [18, 90, 250, 700, 875, 1050], houseCost: 150, group: "red" },
  { id: 24, name: "Illinois Avenue", type: "property", pokemon: "Tinkatink", cost: 240, rent: [20, 100, 300, 750, 925, 1100], houseCost: 150, group: "red" },
  { id: 25, name: "B&O Railroad", type: "station", pokemon: "Rookidee", cost: 200, rent: [25, 50, 100, 200], group: "station" },
  { id: 26, name: "Atlantic Avenue", type: "property", pokemon: "Wattrel", cost: 260, rent: [22, 110, 330, 800, 975, 1150], houseCost: 150, group: "yellow" },
  { id: 27, name: "Ventnor Avenue", type: "property", pokemon: "Tadbulb", cost: 260, rent: [22, 110, 330, 800, 975, 1150], houseCost: 150, group: "yellow" },
  { id: 28, name: "Water Works", type: "utility", pokemon: "Rotom", cost: 150, rent: [4, 10], group: "utility" },
  { id: 29, name: "Marvin Gardens", type: "property", pokemon: "Pawmot", cost: 280, rent: [24, 120, 360, 850, 1025, 1200], houseCost: 150, group: "yellow" },
  { id: 30, name: "Go To Jail", type: "gotojail", cost: 0, rent: 0, group: "corner" },
  { id: 31, name: "Pacific Avenue", type: "property", pokemon: "Dondozo", cost: 300, rent: [26, 130, 390, 900, 1100, 1275], houseCost: 200, group: "green" },
  { id: 32, name: "North Carolina Avenue", type: "property", pokemon: "Tatsugiri", cost: 300, rent: [26, 130, 390, 900, 1100, 1275], houseCost: 200, group: "green" },
  { id: 33, name: "Community Chest", type: "raid", cost: 0, rent: 0, group: "card" },
  { id: 34, name: "Pennsylvania Avenue", type: "property", pokemon: "Veluza", cost: 320, rent: [28, 150, 450, 1000, 1200, 1400], houseCost: 200, group: "green" },
  { id: 35, name: "Short Line Railroad", type: "station", pokemon: "Rookidee", cost: 200, rent: [25, 50, 100, 200], group: "station" },
  { id: 36, name: "Chance", type: "academy", cost: 0, rent: 0, group: "card" },
  { id: 37, name: "Park Place", type: "property", pokemon: "Ceruledge", cost: 350, rent: [35, 175, 500, 1100, 1300, 1500], houseCost: 200, group: "dark-blue" },
  { id: 38, name: "Luxury Tax", type: "tax", cost: 100, rent: 0, group: "tax" },
  { id: 39, name: "Boardwalk", type: "property", pokemon: "Miraidon", cost: 400, rent: [50, 200, 600, 1400, 1700, 2000], houseCost: 200, group: "dark-blue" }
];
